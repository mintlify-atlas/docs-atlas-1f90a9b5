---
title: Structs
description: Learn about structs in Go - user-defined types that group related data together
---
...
Make sure to provide all field values:
...
When we assign one `struct` variable to another, a new copy of the `struct` is created and assigned.
...
**Empty struct occupies zero bytes**

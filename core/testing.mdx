---
title: 'Testing'
description: 'Learn how to write tests, benchmarks, and measure code coverage in Go'
---
...
<Info>
This is a really cool feature of Go 1.18. You can learn more about fuzz testing from the [official Go blog](https://go.dev/doc/fuzz).
</Info>